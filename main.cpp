...
const double MUTATION_RATE = 0.85;
...
int main(int argc, char **agrv) {
  ...
  vector<vector<int> > sudoku({{7,3,5,6,0,4,0,0,2},{8,4,0,2,9,7,3,5,6},{9,0,1,2,8,5,3,7,0},{2,8,0,3,4,9,1,0,7},{4,1,0,8,5,7,0,2,6},{5,7,0,1,2,6,0,3,8},{1,5,7,4,9,2,6,8,0},{6,9,4,7,3,0,2,1,5},{3,2,8,0,6,1,0,4,9}});
  printSudoku(sudoku);
    vector<vector<int> > spots({{6,7},{3},{1},{2,7},{2,6},{2,6},{8},{5},{3,6}});
  ...
  int generation = 1;
    ...
    for (int i = next_population.size(); i < init_population_size; i++) {
